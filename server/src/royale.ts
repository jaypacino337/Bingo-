 ...
 *
 * IMPORTANT: mirrored byte-for-byte at lib/royale.ts so the browser can replay
 * a settled round from the revealed seed and check it was not rigged. If you
 * change this file, copy it across:
 *
